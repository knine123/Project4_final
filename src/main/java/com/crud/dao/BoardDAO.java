...
public class BoardDAO {
	...
	private final String BOARD_UPDATE = "update BOARD set category=?, title=?, writer=?, content=?, edit_time=CURRENT_TIMESTAMP where seq=?";
	...
	public List<BoardVO> getBoardList(){
		...
		try {
			...
			while(rs.next()) {
				...
				one.setEdit_time(rs.getDate("edit_time"));
				one.setCnt(rs.getInt("cnt"));
				list.add(one);
			}
			rs.close();
